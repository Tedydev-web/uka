jQuery(document).ready(function () {
    ...
    jQuery('#form_reg_user').submit(function(){
        var err = 0;
        postall_or('hide_me',hr.a_url+'?action=registry','reg_user_name||reg_user_mail');
    });
    ...
    jQuery(document).delegate( ".submit_filter", "click", function(e) {
        ...
        postbyurl('load_office', hr.a_url + '?action=load_office','id_parent=' + id_parent + '&id_child=' + id_child );
