jQuery(document).ready(function () {
    ...
    if (phoneFieldValue.length < minLength || phoneFieldValue.length > maxLength) {
...
function q_a() {
    ...
    jQuery(document).delegate(".sec_question .box_content .content.active .title", "click", function() {
        jQuery('.sec_question .box_content .content .content_group').slideUp()
        jQuery('.sec_question .box_content .content').removeClass('active');
    })

    jQuery(document).delegate(".sec_question .box_content .content:not(.active) .title", "click", function() {
        jQuery('.sec_question .box_content .content').removeClass('active');
