...
<header class="site-header has-inline-mobile-toggle" id="masthead" aria-label="Site"
    ...
    <div class="inside-header grid-container">
        <div class="site-logo">
            <a href="{{ Route::has('home') ? route('home') : '#' }}" title="UKA School" rel="home">
                <img class="header-image is-logo-image" alt="UKA School"
                    src="{{ asset('assets/wp-content/uploads/2022/12/Frame.svg') }}" title="UKA School"
                    width="309" height="95" />
            </a>
        </div>
        <nav class="main-navigation mobile-menu-control-wrapper" id="mobile-menu-control-wrapper"
            aria-label="Mobile Toggle">
            <button data-nav="site-navigation" class="menu-toggle" aria-controls="primary-menu"
                aria-expanded="false">
        ...
        <nav class="main-navigation sub-menu-right" id="site-navigation" aria-label="Primary"
                ...
                <div class="nav_right">
                    <a href="#" class="search_open">
                        <svg width="30" height="31" viewBox="0 0 30 31" fill="none"
                            ...
                            <path
                                d="M13.5935 23.8357C19.0301 23.8357 23.4373 19.5254 23.4373 14.2084C23.4373 8.89136 19.0301 4.58105 13.5935 4.58105C8.15695 4.58105 3.74976 8.89136 3.74976 14.2084C3.74976 19.5254 8.15695 23.8357 13.5935 23.8357Z"
                                stroke="#3D415D" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                            <path d="M20.5536 21.0166L26.249 26.5868" stroke="#3D415D" stroke-width="2"
                                stroke-linecap="round" stroke-linejoin="round" />
                        </svg>
                    </a>

                    <div class="group_popup">
                        <a href="#popup_1" class="see_more" data-fancybox="">
                            <div class="icon">
                                <svg width="32" height="33" viewBox="0 0 32 33" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
                                        d="M9.51694 18.7119L4.72369 22.7119V6.71191C4.72369 6.4467 4.82576 6.19234 5.00743 6.00481C5.18911 5.81727 5.43552 5.71191 5.69244 5.71191H21.1924C21.4494 5.71191 21.6958 5.81727 21.8775 6.00481C22.0591 6.19234 22.1612 6.4467 22.1612 6.71191V17.7119C22.1612 17.9771 22.0591 18.2315 21.8775 18.419C21.6958 18.6066 21.4494 18.7119 21.1924 18.7119H9.51694Z"
                                        stroke="white" stroke-width="2" stroke-linecap="round"
                                        stroke-linejoin="round" />
                                    <path
                                        d="M10.5362 18.7119V23.7119C10.5362 23.9771 10.6383 24.2315 10.8199 24.419C11.0016 24.6066 11.248 24.7119 11.5049 24.7119H23.1805L27.9737 28.7119V12.7119C27.9737 12.4467 27.8716 12.1923 27.69 12.0048C27.5083 11.8173 27.2619 11.7119 27.0049 11.7119H22.1612"
                                        stroke="white" stroke-width="2" stroke-linecap="round"
                                        stroke-linejoin="round" />
                                </svg>
                            </div>
            ...
            <div id="popup_1" class="popup">
                <div class="wpcf7 no-js" id="wpcf7-f915-o1" lang="en-US" dir="ltr">
                    <div class="screen-reader-response">
                        <p role="status" aria-live="polite" aria-atomic="true"></p>
                        <ul></ul>
                    </div>
                    <form action="/#wpcf7-f915-o1" method="post" class="wpcf7-form init" aria-label="Contact form"
                        ...
                        <div class="wrap_form">
                            ...
                            <div class="grid-50">
                                ...
                                <p><br />
                                    <span class="wpcf7-form-control-wrap" data-name="campus"><select
                                            class="wpcf7-form-control wpcf7-select wpcf7-validates-as-required"
                                            aria-required="true" aria-invalid="false" name="campus">
                                            <option value="UKA Hạ Long">UKA Hạ Long</option>
                                            <option value="UKA Huế">UKA Huế</option>
                                            <option value="UKA Đà Nẵng">UKA Đà Nẵng</option>
                                            <option value="UKA Quảng Ngãi">UKA Quảng Ngãi</option>
                                            <option value="UKA Bình Thạnh">UKA Bình Thạnh</option>
                                            <option value="UKA Vũng Tàu">UKA Vũng Tàu</option>
                                            <option value="UKA Gia Lai">UKA Gia Lai</option>
                                        </select></span><br />
                                </p>
                            </div>
                            <p><br />
                            ...
                            <div class="grid-50">
                                ...
                                <p><br />
                                    <span class="wpcf7-form-control-wrap" data-name="your-number"><input
                                            class="wpcf7-form-control wpcf7-number wpcf7-validates-as-required wpcf7-validates-as-number"
                                            aria-required="true" aria-invalid="false"
                                            placeholder="Nhập số điện thoại" value="" type="number"
                                            name="your-number" /></span><br />
                                </p>
                            </div>
                            <p><br />
                            </p>
                            <div class="grid-100">
                                ...
                                <p><br />
                                    <span class="wpcf7-form-control-wrap" data-name="Request">
                                        <textarea cols="40" rows="10" class="wpcf7-form-control wpcf7-textarea" aria-invalid="false"
                                            placeholder="Nhập nội dung tin nhắn" name="Request"></textarea>
                                    </span><br />
                                </p>
                            </div>
                            <p><br />
